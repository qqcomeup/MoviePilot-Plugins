...
| 插件 | 说明 | 文档 |
| --- | --- | --- |
| iKuai HomePage v1.3 | 将爱快本地路由监控数据转换为 Homepage customapi 接口。 | [查看说明](plugins.v2/ikuaihomepage/README.md) |
...
| OpenWrt HomePage v1.0 | 将 OpenWrt 路由监控数据转换为 Homepage customapi 接口。 | [查看说明](plugins.v2/openwrthomepage/README.md) |
