...
class Cd2AssistantFix(_PluginBase):
    # 插件名称
    plugin_name = "CloudDrive2助手修复版"
    # 插件描述
    plugin_desc = "CloudDrive2助手修复版，复用 clouddrive2_client 避免 proto 重复注册冲突。"
    # 插件图标
    plugin_icon = "https://raw.githubusercontent.com/thsrite/MoviePilot-Plugins/main/icons/clouddrive.png"
    # 插件版本
    plugin_version = "2.0.5.1"
    # 插件作者
    plugin_author = "thsrite"
    # 作者主页
    author_url = "https://github.com/thsrite"
    # 插件配置项ID前缀
    plugin_config_prefix = "cd2assistantfix_"
    # 加载顺序
    plugin_order = 5
    # 可使用的用户级别
    auth_level = 2
